...
<table width="100%">
	<tr><td align="${left}" class="table-head"><primo:label code="Change Password"/></td></tr>
</table>
<form:form action="${ctx}/login/updatepassword.do" name="passwordForm" commandName="modelObject" method="post">
