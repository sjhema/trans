...
<form:form action="save.do" name="typeForm" commandName="modelObject"
	...
	<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
		<tr class="table-heading">
			<td align="${left}" colspan="4"><b><primo:label code="Add/Update Fuel Vendors"/></b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align="${left}">
				<form:textarea path="address" cssClass="flat" style="min-width:200px; max-width:200px"/>
				 <br><form:errors path="address" cssClass="errorMessage" />
			</td>
			<td class="form-left"><primo:label code="Address Line2"/></td>
			<td align="${left}">
				<form:textarea path="address2" cssClass="flat" style="min-width:200px; max-width:200px"/>
		...
		<tr>
			...
			<td align="${left}">
				<form:select cssClass="flat" path="state" cssStyle="width:200px;">
					<form:option value="">-----------Please Select----------</form:option>
