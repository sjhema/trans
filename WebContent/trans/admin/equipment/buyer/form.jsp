...
function submitForm(){
	if(submitting) {
    	alert('Please wait a moment...');
         ...
         submitting = true;
         document.forms["equipmentBuyerForm"].submit();
	}
}
...
<h3>
	<primo:label code="Add/Update Equiment Buyer" />
</h3>
<form:form action="save.do" name="equipmentBuyerForm" commandName="modelObject" method="post">
	<form:hidden path="id" id="id" />
	<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
		<tr class="table-heading">
			<td colspan="6"><b><primo:label code="Equipment Buyer" /></b></td>
		</tr>
		<tr>
