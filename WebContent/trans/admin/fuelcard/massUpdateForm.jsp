...
function submitform() {
	...
	submitting = true;
	document.forms["bulkUpdateFuelCardForm"].submit();
}
...
<h3>
	<primo:label code="Bulk Update Fuel Cards" />
</h3>
<form:form action="updatebulkeditdata.do" name="bulkUpdateFuelCardForm" commandName="modelObject"
	method="post">
