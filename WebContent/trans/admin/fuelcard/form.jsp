...
<h3><primo:label code="Manage Fuel Card"/></h3>
<form:form action="save.do" name="fuelcardForm"
	commandName="modelObject" method="post">
	<form:hidden path="id" id="id" />
	<table width="100%" id="form-table">
		<tr class="table-heading">
			<td colspan="2"><b><primo:label code="Add/Update Fuel Card" />
			</b>
			</td>
		</tr>
		<tr>
			<td class="form-left"><primo:label code="Fuel Vendors" /><span
				class="errorMessage">*</span>
			</td>
			<td><form:select cssClass="flat" path="fuelvendor" style="min-width:184px; max-width:184px">
		...
		<tr>
			<td class="form-left"><primo:label code="Fuel Card Number" />
			</td>
			<td align="${left}"><form:input path="fuelcardNum" cssClass="flat"
					style="min-width:180px; max-width:180px" maxlength="20" /> <br> <form:errors
					path="fuelcardNum" cssClass="errorMessage" />
			</td>
		</tr>
		...
		<tr>
			...
			<td align="${left}"><form:input id="datepicker" path="validFrom" style="min-width:180px; max-width:180px"
