...
<br/>
<form:form action="${ctx}/admin/roadsideinspec/roadsideinspecmaint/managedocs/save.do" method="post" name="manageDocsForm" enctype="multipart/form-data" modelAttribute="modelObject">
<form:hidden path="id" id="id" />
<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
	<tr class="table-heading">
		<td colspan="4"><b><primo:label code="Manage Roadside Inspection Pdf" /></b></td>
	</tr>
	<tr>
	...
	<tr class="table-heading">
		<td colspan="6"><b><primo:label code="Upload Roadside Inspection Pdf" /></b></td>
	</tr>
	<tr>
		<td align="${left}" class="first"><primo:label code="Upload Roadside Inspection Pdf" /><span class="errorMessage"></span>
		<td align="${left}">
	...
	<tr>
		<td>
			...
			<input type="button" id="cancelBtn" value="<primo:label code="Cancel"/>" class="flat"
				onClick="document.location.href='${ctx}/admin/roadsideinspec/roadsideinspecmaint/list.do'" />
		</td>
	</tr>
</table>
</form:form>
...
<c:if test="${not empty errorList}">
	<b>Following errors occured while managing roadside inspection docs:</b><br/>
