...
<br/>
<form:form action="${ctx}/admin/accident/accidentmaint/managedocs/save.do" method="post" name="manageDocsForm" enctype="multipart/form-data" modelAttribute="modelObject">
<form:hidden path="id" id="id" />
<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
	<tr class="table-heading">
		<td colspan="4"><b><primo:label code="Manage Accident Pdf" /></b></td>
	</tr>
	<tr>
	...
	<tr class="table-heading">
		<td colspan="6"><b><primo:label code="Upload Accident Pdf" /></b></td>
	</tr>
	<tr>
...
<c:if test="${not empty errorList}">
	<b>Following errors occured while managing accident docs:</b><br/>
