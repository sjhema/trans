...
<h3>
	<primo:label code="Manage Tonnage Premium Padd" />
</h3>
<form:form action="search.do" method="get" name="searchForm">
	<table width="100%" id="form-table">
		<tr class="table-heading">
			<td colspan="4"><b><primo:label code="Search Tonnage Premium Padd" /></b></td>
		</tr>
		<tr>
...
<form:form name="delete.do" id="serviceForm">
	<primo:datatable urlContext="admin/tonnagepremium" deletable="true"
		...
		<primo:textcolumn headerText="Premium Tonnes" dataField="premiumTonne" dataFormat="#0.00" />
