...
<form:form action="save.do" name="fuelsurchargepaddForm"
	commandName="modelObject" method="post">
	<form:hidden path="id" id="id" />
	<table width="100%" id="form-table">
		<tr class="table-heading">
			<td colspan="2"><b><primo:label code="Add/Update Tonnage Premium Padd" />
			</b>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="form-left"><primo:label code="Premium Tonnes" /><span
				class="errorMessage">*</span>
			</td>
			<td align="${left}"><form:input path="premiumTonne" cssClass="flat"
					style="min-width:150px; max-width:150px" maxlength="20" /> <br> <form:errors
					path="premiumTonne" cssClass="errorMessage" />
			</td>
		</tr>
		<tr>
