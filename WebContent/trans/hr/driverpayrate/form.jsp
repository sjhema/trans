...
<form:form action="save.do?fromAlertPage=${fromAlertPage}" name="employeeForm" commandName="modelObject"
	...
	<td class="form-left"><primo:label code="Category" /><span
		...
		<td class="form-left">Night Rate (USD)<span class="errorMessage">*</span>
			...
			<tr>
		<td class="form-left">Probation Rate (USD
			</td>
			<td align="${left}"><form:input path="probationRate" style="min-width:150px; max-width:150px"/>
			<br><form:errors path="probationRate" cssClass="errorMessage" /></td>
		</tr>
		...
		<tr>
			...
			<td align="${left}">
				<input type="submit"
					name="create" id="create" onclick="" value="<primo:label code="Save"/>" class="flat" />
				...
				<c:if test="${fromAlertPage ne null and fromAlertPage eq 'true'}">
					<c:set var="cancelAction" value="JavaScript:window.location='${ctx}/hr/payrollratealert/list.do?type=driverPayRate';"/>
				</c:if>
