...
<%
	...
	buffer.append("<input type=\"button\" value=\"Back\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/leaveaccrual/start.do'\">");
	buffer.append("&nbsp;<input type=\"button\" value=\"Export as pdf\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/leaveaccrual/export.do?type=pdf'\">");
	buffer.append("&nbsp;<input type=\"button\" value=\"Export as csv\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/leaveaccrual/export.do?type=csv'\">");
	buffer.append("</table>\n");
