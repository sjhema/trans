...
<%
	...
	buffer.append("<input type=\"button\" value=\"Back\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/remainingleave/start.do'\">");
	buffer.append("<input type=\"button\" value=\"Export as Pdf\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/remainingleave/export.do?type=pdf'\">");
	buffer.append("<input type=\"button\" value=\"Export as csv\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/remainingleave/export.do?type=csv'\">");
