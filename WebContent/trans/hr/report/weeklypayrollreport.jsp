...
<form:form action="search.do?for=payrollreport" method="post"
	name="searchForm">
	<br/>
	<br/>
	<table id="form-table" width="100%" cellspacing="0" cellpadding="5">
		<tr class="table-heading">
			<td align="${left}" colspan="9"><b>Salary Payroll Report</b></td>
		</tr>
			<tr>
...
<table width="100%">
	<tr>
		<td align="${left}" width="100%" align="right">
			<%-- <a href="${ctx}/hr/report/weeklysalarypayroll/save.do" target="reportData" id="save" onclick="
			var c=document.getElementById('company').value;
			...
			<a href="${ctx}/hr/report/weeklysalarypayroll/export.do?type=print&for=payrollreport" target="reportData"><img src="${ctx}/images/print.png" border="0" class="toolbarButton"/></a>
			<a href="${ctx}/hr/report/weeklysalarypayroll/export.do?type=pdf&for=payrollreport" target="reportData"><img src="${ctx}/images/pdf.png" border="0" class="toolbarButton"/></a>
			<a href="${ctx}/hr/report/weeklysalarypayroll/export.do?type=xls&for=payrollreport" target="reportData"><img src="${ctx}/images/excel.png" border="0" class="toolbarButton"/></a>
			<a href="${ctx}/hr/report/weeklysalarypayroll/export.do?type=csv&for=payrollreport" target="reportData"><img src="${ctx}/images/csv.png" border="0" class="toolbarButton"/></a>
		</td>
		</tr>
