...
<%
	...
	buffer.append("<input type=\"button\" value=\"Back\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/employeereport/start.do'\">");
	buffer.append("<input type=\"button\" value=\"Export As Pdf\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/employeereport/export.do?type=pdf'\">");
	buffer.append("<input type=\"button\" value=\"Export As CSV\" onclick=\"javascript:location.href='"+request.getContextPath()+"/hr/report/employeereport/export.do?type=csv'\">"); 
	buffer.append("</table>\n");
