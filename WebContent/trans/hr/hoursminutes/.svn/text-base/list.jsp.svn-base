...
<form:form name="delete.do" id="serviceForm">
	<primo:datatable urlContext="hr/hoursminutes" deletable="true"
		...
		<primo:textcolumn headerText="Hours Format" dataField="hoursformat" />
		<primo:textcolumn headerText="hoursvalues" dataField="hoursvalues" />
		<primo:textcolumn headerText="minuts" dataField="minutes" />
