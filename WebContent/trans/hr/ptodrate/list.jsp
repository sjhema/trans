...
<form:form name="delete.do" id="serviceForm">
	<primo:datatable urlContext="hr/ptodrate" deletable="true"
		...
		<primo:textcolumn headerText="Ptod Rate" dataField="ptodRate" />
