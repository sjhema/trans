...
<script type="text/javascript">
	function getComTermCatagory() {
		...
		jQuery.ajax({
			url : '${ctx}/hr/ptodrate/ajax.do?action=findDCompany&driver='
					+ driver,
		...
		jQuery.ajax({
			url : '${ctx}/hr/ptodrate/ajax.do?action=findDTerminal&driver='
					+ driver,
			success : function(data) {
				var listData = jQuery.parseJSON(data);
				var options;
		...
		jQuery.ajax({
			url : '${ctx}/hr/ptodrate/ajax.do?action=findDCategory&driver='
					+ driver,
			success : function(data) {
				var listData = jQuery.parseJSON(data);
				var options;
		...
		jQuery.ajax({
			url:'${ctx}/hr/ptodrate/ajax.do?action=findDStaff&driver='+driver, 
			success: function( data ) {
				var listData=jQuery.parseJSON(data);
...
<h3>
	<primo:label code="Add/Update Ptod Rate" />
</h3>
...
<tr class="table-heading">
			<td colspan="4"><b><primo:label code="Add/Update Ptod Rate"/></b></td>
		</tr>
		<tr>
...
<tr>
		 <td class="form-left"><primo:label code="Company" /><span	class="errorMessage">*</span></td>
		 	<td><form:select cssClass="flat" style="min-width:154px; max-width:154px" path="company" id="company" >
			 ...
			 <td class="form-left"><primo:label code="Terminal" /><span	class="errorMessage">*</span></td>
		      <td><form:select cssClass="flat" style="min-width:154px; max-width:154px" path="terminal" id="terminalId" >
					<form:option value="">------<primo:label
							code="Please Select" />------</form:option>
		...
		<tr>
			...
			<td class="form-left"><primo:label code="Ptod Rate" />
			</td>
			<td align="${left}"><form:input path="ptodRate" id="" cssClass="flat"
					style="min-width:150px; max-width:150px" maxlength="20" /> <br>
					 <form:errors path="ptodRate" cssClass="errorMessage" /></td>
		...
		<tr>
			...
			<td align="${left}"><form:input path="validFrom" cssClass="flat" style="min-width:150px; max-width:150px"
					id="datepicker" onblur="return formatDate1();" /> <br> <form:errors
			...
			<td align="${left}"><form:input path="validTo" cssClass="flat" style="min-width:150px; max-width:150px"
					id="datepicker1" onblur="return formatDate();" /> <br> <form:errors
