...
<form:form action="save.do" name="typeForm" commandName="modelObject"
	...
	<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
		<tr class="table-heading">
			<td align="${left}" colspan="2"><b><primo:label code="Add/Update Setup Data"/></b></td>
		</tr>
		<tr>
			<td class="form-left"><primo:label code="Data Type"/><span
				class="errorMessage">*</span></td>
			<td align="${left}">
				<form:input path="dataType" style="min-width:150px; max-width:150px"/>
					
				
			<%-- <form:input path="dataType" cssClass="flat" cssStyle="width:175px;"/> --%><br><form:errors path="dataType" cssClass="errorMessage"/></td>
		</tr>
		<tr>
			<td class="form-left"><primo:label code="Data Text"/><span
				class="errorMessage">*</span></td>
			<td align="${left}"><form:input path="dataLabel" cssClass="flat" style="min-width:150px; max-width:150px"/><br><form:errors path="dataLabel" cssClass="errorMessage"/></td>
		</tr>
		<tr>
