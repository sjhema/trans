...
function submitform(type){
	var vehicle=document.getElementById('truckId').value;
	...
	if(vehicle!="" || trailer!=""){
			...
			document.forms["ticketForm"].action='${ctx}/operator/ticket/updatebulkeditdata.do';
		 	if(submitting) {
...
function checkBatchDate() {
	var billbatchdate=document.getElementById("datepicker2").value;
	var loaddate=document.getElementById("datepicker").value;
	var unloaddate=document.getElementById("datepicker1").value;
...
<h3>
	<primo:label code="Bulk Update Tickets" />
</h3>
<form:form action="updatebulkeditdata.do" name="ticketForm" commandName="modelObject"
	...
	<table id="form-table" width="100%" cellspacing="1" cellpadding="5">
		...
		<td class="form-left"><primo:label code="Employee Company" /><span class="errorMessage">*</span>
			...
			<td align="${left}"><form:input id="datepicker2" path="billBatch" style="min-width:150px; max-width:150px"
					cssClass="flat" onblur="return formatDate2();" onchange="return checkBatchDate();"/> <br> <form:errors
					path="billBatch" cssClass="errorMessage" />
			</td>
		</tr>
	<%-- 	<tr>
		...
		<tr>
			...
			<td class="form-left"><primo:label code="Hold/UnHold" /><span
				class="errorMessage">*</span></td>
			<td><form:select cssClass="flat" path="ticketStatus">
			<form:option value="">------<primo:label
							code="Please Select" />------</form:option>
		...
		<tr>
			...
			<td class="form-left"><primo:label code="Origin Ticket#" /><span
				class="errorMessage">*</span></td>
			<td align="${left}"><form:input path="originTicket" id="originticket" disabled="true" style="min-width:150px; max-width:150px" onblur="return checkLandfillTicket();" 
		...
		<tr>
			...
			<td class="form-left"><primo:label code="Destination Ticket#" /><span
				class="errorMessage">*</span></td>
			<td align="${left}"><form:input path="destinationTicket" disabled="true" style="min-width:150px; max-width:150px" id="destinationticket" onblur="return checkTransferTicket();"
