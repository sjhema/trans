...
( function($) {
	...
	$.fn.collapsibleCheckboxTree = function(options) {
		...
		var defaults = {
			...
			initialState : 'default' // Options - 'expand' (fully expanded),
		// 'collapse' (fully collapsed) or
		// default
		};
		...
		this.each( function() {
			...
			// Add button
				$(this)
						.before(
								'<a href="#" id="expand" style="color:gray;" >Expand All</a> | <a href="#" id="collapse" style="color:gray;"> Collapse All </a>');
				// ********* *****
