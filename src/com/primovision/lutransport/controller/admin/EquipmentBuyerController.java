...
@Controller
@RequestMapping("/admin/equipment/buyer")
public class EquipmentBuyerController extends CRUDController<EquipmentBuyer> {
	public EquipmentBuyerController() {
		setUrlContext("admin/equipment/buyer");
	}
	...
	private void validateSave(EquipmentBuyer entity, BindingResult bindingResult) {
	...
	public String save(HttpServletRequest request,
			@ModelAttribute("modelObject") EquipmentBuyer entity,
		...
		request.getSession().setAttribute("msg", "Equipment buyer saved successfully");
		
		setupCreate(model, request);
		
		if (entity.getModifiedBy() == null) {
			model.addAttribute("modelObject", new EquipmentBuyer());
		}
