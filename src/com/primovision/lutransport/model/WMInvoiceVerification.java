...
public class WMInvoiceVerification implements ReportModel {
	...
	public static String WM_INVOICE_MATCHING_REPORT = "wmInvoiceMatchingTickets";
	public static String WM_INVOICE_DISCREPANCY_REPORT = "wmInvoiceTicketsDiscrepancy";
