...
invoice_number,company_loc,custmr_id,is_peak_rate,loading_fee
...
invoice_numbers,compnay_locations,customer_ids,isPeakRate,loadingFee
...
unload_dates,driverPayRate,isPeakRate,loadingFee);
