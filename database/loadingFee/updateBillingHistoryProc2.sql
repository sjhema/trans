...
delete from invoice_detail_new where tickt_id=tick_id ;
...
OriginName,UnitNumber,TerminalName,ticket_id,TonnagePremium,TotAmount,TrailerNumber,transfer_time_ins,tranfer_time_outs,Unload_date_var,PaddCode,destinations,origins,drivercompany_name,drivercompany_id,unload_dates,driverPayRate,'N',0.0);
