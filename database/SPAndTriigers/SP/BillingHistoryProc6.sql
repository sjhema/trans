...
rate,tonnage_premium,total_amount,bill_gross,bill_net,bill_tare,bill_tons,invoice_date,invoice_number,company_loc,custmr_id

into FAmount,DemmurageCharge,fuelSurcharge,Minimumbillablegrossweight,FRate,

TonnagePremium,TOtAmount,EffectiveGrossWt,EffectiveNetWt,EffectiveTareWt,EffectiveTonsWt,invoice_dates,invoice_numbers,compnay_locations,customer_ids
