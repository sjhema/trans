CREATE DEFINER=`lutransport`@`%` PROCEDURE `SubcontractorInvoice1`(IN `rate_transfer_id` BIGINT(150), IN `rate_subcontractor_id` BIGINT(150))
BEGIN
...
voucher_date,voucher_status,gallon from ticket where voucher_status=1 and origin=rate_transfer_id and destination in (253,254) and subcontractor_id=rate_subcontractor_id;
